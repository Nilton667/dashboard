...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Motoristas</h3>
    </div>
</div>
								...
								<div class="col-12 col-md-5">
									<form method="GET">
										<div class="input-group mb-2 card-body-search">
											<input type="hidden" name="motoristas">
											<input type="text" class="form-control" name="filtro" value="<?php if(isset($_GET['filtro'])): echo trim($_GET['filtro']); endif; ?>" placeholder="ID/Ref/Registo">
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from uber_motoristas WHERE id_usuario LIKE '%$busca'";
                                        $select.= " OR ref LIKE '%$busca'";
										$select.= " OR registo LIKE '%$busca' ORDER BY id DESC";
									else:
										$select = 'SELECT * from uber_motoristas ORDER BY id DESC';
									endif;
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="motorista-id">
											<label class="custom-control-label" for="motorista-id"></label>
										</div>'
										);
                                        ...
                                        $user = DB\Mysql::get("usuarios", "*", "id = $mostra->id_usuario", 1);
                                        if(!is_array($user)){
                                            continue;
                                        }else{
                                            $user = $user[0];
										...
										?>
										<tr>
											<th scope="row"><?php echo $mostra->id_usuario; ?></th>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														motorista-select="<?php echo $mostra->id; ?>"
														id="motorista-<?php echo $mostra->id; ?>">
														
														<label
														class="custom-control-label"
														for="motorista-<?php echo $mostra->id; ?>"></label>

													</div>
													
													<i class="las la-file-alt"
													id="motorista-visualize"
													data-nome="<?= $user['nome'].' '.$user['sobrenome']; ?>"
													data-identificacao="<?php if($user['identificacao'] == ''): echo 'n/a'; else: echo $user['identificacao']; endif; ?>"
                                                    data-nacionalidade="<?php if($user['nacionalidade'] == ''): echo 'n/a'; else: echo $user['nacionalidade']; endif; ?>"
                                                    data-morada="<?php if($user['morada'] == ''): echo 'n/a'; else: echo $user['morada']; endif; ?>"
                                                    data-senha="<?php if($mostra->senha == ''): echo 'n/a'; else: echo $mostra->senha; endif; ?>"
										...
										$paginacao->queryString = 'motoristas';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?motoristas";</script>';
											exit(); 
										endif;
      ...
      <div class="modal-body">
	  	<div class="bg-white p-1">
			...
			<div class="form-group">
				<label for="senha">ID de usuário</label>
				<div class="input-group">
					<div class="input-group-prepend">
						<i class="input-group-text las la-user"></i>
					</div>
					<input type="number" class="form-control" id="set_id" name="set_id" value="0">
				</div>
			</div>
...
<!-- Dados de motorista -->
<div class="modal fade" id="show-motorista" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		<div class="modal-header">
		...
		<div class="modal-body">
            <ul class="list-group">
                ...
                <li class="list-group-item"><span style="font-weight: 500;">Senha:</span> <span id="modal-user-senha"></span></li>
            </ul>
        </div>
		<div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
...
<script src="assets/js/uber/motoristas.js"></script>
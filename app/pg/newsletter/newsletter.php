                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements-ignore d-flex justify-content-end">
                        <ul class="list-inline mb-0">
                          <li><a data-bs-toggle="modal" data-bs-target="#modal-new-email" class="mr-2"><i class="las la-sms"></i></a></li>
                          <li><a data-bs-toggle="modal" data-bs-target="#modal-new-user" class="mr-2"><i class="ft-plus"></i></a></li>

    ...
    <div class="col-12 mt-2">
        <div class="row">
            ...
            if(isset($_GET['edit'])):
                ...
                if(isset($_GET['edit']) && isset($data[0]->id) && $data[0]->origem == 'file' || isset($_GET['edit']) && isset($data[0]->id) && $data[0]->origem == 'link' || isset($_GET['edit']) && isset($data[0]->id) && $data[0]->origem == 'youtube'){
                    ?>
                    <div class="col-12 col-sm-6">
                        ...
                        <div>
                            <?php
                                if($data[0]->origem == 'link'){
                                    ...
                                    <?php
                                }else if($data[0]->origem == 'youtube'){
                                    $youtube_link = parse_url($data[0]->video);
                                    parse_str($youtube_link['query'], $youtube_link);
                                    ?>
                                    <iframe 
                                    style="width: 100%;  border-radius: 8px;"
                                    id="youtube-frame" 
                                    width="100%" 
                                    height="315" 
                                    src="https://www.youtube.com/embed/<?= $youtube_link['v']; ?>" 
                                    frameborder="0" 
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="transmicao-origem" name="origem">
                            ...
                            <option <?= isset($data[0]->origem) && $data[0]->origem == 'youtube' ? 'selected' : ''; ?> value="youtube">Youtube</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            if($edit && $data[0]->origem == 'link'){
                                ?>
                                    <input type="url" name="video" class="form-control" id="transmicao-video" placeholder="Vídeos url" value="<?php if($edit && $data[0]->origem != 'file'){ echo $data[0]->video; } ?>">
                                <?php
                                ...
                                <?php
                            }else if($edit && $data[0]->origem == 'youtube'){
                                ?>
                                    <input type="url" name="video" class="form-control" id="transmicao-video" placeholder="Youtube vídeos url" value="<?php if($edit && $data[0]->origem != 'file'){ echo $data[0]->video; } ?>">
                                <?php
                            } else{
                                ?>
                                <input type="url" name="video" class="form-control" id="transmicao-video" placeholder="Vídeos url">
                                <?php
                            }
                        ?>
                    </div>

							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if(is_array($result)){
										...
										?>
										<tr <?php if($value['entrega'] == 0): echo 'class="table-danger"'; endif; ?>>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														historico-select="<?php echo $value['id']; ?>"
														id="historico-<?php echo $value['id']; ?>">
														
														<label 
														class="custom-control-label" 
														for="historico-<?php echo $value['id']; ?>"></label>
													</div>

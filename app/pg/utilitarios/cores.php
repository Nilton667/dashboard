...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Cores</h3>
    </div>
</div>
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from cor WHERE cor LIKE '%$busca%'";
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="cor-id">
											<label class="custom-control-label" for="cor-id"></label>
										</div>'
										);
										...
										<tr>
                                            ...
                                            <td id="cor-nome-<?php echo $mostra->id; ?>">
                                                <?php echo $mostra->cor;  ?>
                                            </td>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														cor-select="<?php echo $mostra->id; ?>"
														id="cor-<?php echo $mostra->id; ?>">
														
														<label 
														class="custom-control-label" 
														for="cor-<?php echo $mostra->id; ?>"></label>
													</div>
													
													<i class="las la-edit modal-edit-<?php echo $mostra->id; ?>"
													id="modal-edit"
													data-cor="<?php echo $mostra->cor; ?>" 
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?cores";</script>';
											exit(); 
										endif;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<input type="hidden" id="edit-cor-id">
        <div class="form-group">
          <label for="edit-cor-nome">Cor</label>
          <input type="text" class="form-control" id="edit-cor-nome" placeholder="Ex: Branco...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary" id="edit-cor">Editar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal-add-item" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="cor-nome">Cor</label>
          <input type="text" class="form-control" id="cor-nome" placeholder="Ex: Branco...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-danger" id="add-cor">Registar</button>
      </div>
    </div>
  </div>
</div>

<script src="assets/js/utilitarios/cor.js"></script>
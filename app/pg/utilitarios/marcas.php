...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Marcas</h3>
    </div>
</div>
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from marca WHERE marca LIKE '%$busca%'";
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="marca-id">
											<label class="custom-control-label" for="marca-id"></label>
										</div>'
										);
										...
										<tr>
                                            ...
                                            <td id="marca-nome-<?php echo $mostra->id; ?>">
                                                <?php echo $mostra->marca;  ?>
                                            </td>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														marca-select="<?php echo $mostra->id; ?>"
														id="marca-<?php echo $mostra->id; ?>">
														
														<label 
														class="custom-control-label" 
														for="marca-<?php echo $mostra->id; ?>"></label>
													</div>
													
													<i class="las la-edit modal-edit-<?php echo $mostra->id; ?>"
													id="modal-edit"
													data-marca="<?php echo $mostra->marca; ?>" 
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?marcas";</script>';
											exit(); 
										endif;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<input type="hidden" id="edit-marca-id">
        <div class="form-group">
          <label for="edit-marca-nome">Marca</label>
          <input type="text" class="form-control" id="edit-marca-nome" placeholder="Ex: Lacoste...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary" id="edit-marca">Editar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="marca-nome" placeholder="Ex: Lacoste...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-danger" id="add-marca">Registar</button>
      </div>
    </div>
  </div>
</div>

<script src="assets/js/utilitarios/marca.js"></script>
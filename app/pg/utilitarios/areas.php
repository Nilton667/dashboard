...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Áreas Construídas</h3>
    </div>
</div>
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from area_construida WHERE area_construida LIKE '%$busca%'";
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											...
											<label class="custom-control-label" for="area-id"></label>
										</div>'
										);
										...
										<tr>
                                            ...
                                            <td id="area-nome-<?php echo $mostra->id; ?>">
                                                <?php echo $mostra->area;  ?>
                                            </td>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														area-select="<?php echo $mostra->id; ?>"
														id="area-<?php echo $mostra->id; ?>">
														
														<label 
														class="custom-control-label" 
														for="area-<?php echo $mostra->id; ?>"></label>
													</div>
													
													<i class="las la-edit modal-edit-<?php echo $mostra->id; ?>"
													id="modal-edit"
													data-area="<?php echo $mostra->area; ?>" 
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?areas";</script>';
											exit(); 
										endif;
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="edit-area-nome">Área</label>
          <input type="text" class="form-control" id="edit-area-nome" placeholder="Ex: Até 100 m²...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary" id="edit-area">Editar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="area-nome" placeholder="Ex: Até 100 m²...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-danger" id="add-area">Registar</button>
      </div>
    </div>
  </div>
</div>

<script src="assets/js/utilitarios/area.js"></script>
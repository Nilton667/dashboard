...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Pavimentos</h3>
    </div>
</div>
							...
							<div class="row m-0 justify-content-center">
								<div class="col-12 col-md-5">
									...
									<div class="input-group mb-2 card-body-search">
										<input type="hidden" name="pavimentos">
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from pavimento WHERE pavimento LIKE '%$busca%'";
									...
									if($contar > 0){
										...
										'<div class="custom-control custom-checkbox">
											<input type="checkbox" class="custom-control-input" id="pavimento-id">
											<label class="custom-control-label" for="pavimento-id"></label>
										</div>'
										);
										...
										<tr>
                                            ...
                                            <td id="pavimento-nome-<?php echo $mostra->id; ?>">
                                                <?php echo $mostra->pavimento;  ?>
                                            </td>
											...
											<th>
												<div class="d-flex w-100 align-items-center">
													<div class="custom-control custom-checkbox d-inline-block">
														...
														pavimento-select="<?php echo $mostra->id; ?>"
														id="pavimento-<?php echo $mostra->id; ?>">
														
														<label 
														class="custom-control-label" 
														for="pavimento-<?php echo $mostra->id; ?>"></label>
													</div>
													
													<i class="las la-edit modal-edit-<?php echo $mostra->id; ?>"
													id="modal-edit"
													data-pavimento="<?php echo $mostra->pavimento; ?>" 
										...
										$paginacao->queryString = 'pavimentos';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?pavimentos";</script>';
											exit(); 
										endif;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<input type="hidden" id="edit-pavimento-id">
        <div class="form-group">
          <label for="edit-pavimento-nome">Pavimento</label>
          <input type="text" class="form-control" id="edit-pavimento-nome" placeholder="Ex: Térreo...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-primary" id="edit-pavimento">Editar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal-add-item" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="pavimento-nome">Pavimento</label>
          <input type="text" class="form-control" id="pavimento-nome" placeholder="Ex: Térreo...">
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-danger" id="add-pavimento">Registar</button>
      </div>
    </div>
  </div>
</div>

<script src="assets/js/utilitarios/pavimento.js"></script>